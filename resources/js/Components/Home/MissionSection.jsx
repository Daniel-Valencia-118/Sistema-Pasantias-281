...
export default function MissionSection({ mision }) {
    // Texto de respaldo por si el admin borra el campo en base de datos
    const fallbackMision = "Impulsamos el desarrollo profesional de los estudiantes conectándolos con el mundo laboral.";
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="order-1 md:order-2 space-y-6">
                    <Card className="border-l-4 border-secondary-teal">
                        <p className="text-lg leading-relaxed text-primary-slate whitespace-pre-line">
                            {mision || fallbackMision}              
                        </p>
                    </Card>
